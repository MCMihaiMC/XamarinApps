...
namespace Com.Squareup.Picasso {
	...
	public partial class UrlConnectionDownloader : global::Java.Lang.Object, global::Com.Squareup.Picasso.IDownloader {
		...
		internal    new     static  readonly    JniPeerMembers  _members    = new XAPeerMembers ("com/squareup/picasso/UrlConnectionDownloader", typeof (UrlConnectionDownloader));
		...
		public unsafe UrlConnectionDownloader (global::Android.Content.Context context)
...
#pragma warning disable 0169
		...
		static IntPtr n_OpenConnection_Landroid_net_Uri_ (IntPtr jnienv, IntPtr native__this, IntPtr native_path)
		{
			global::Com.Squareup.Picasso.UrlConnectionDownloader __this = global::Java.Lang.Object.GetObject<global::Com.Squareup.Picasso.UrlConnectionDownloader> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			global::Android.Net.Uri path = global::Java.Lang.Object.GetObject<global::Android.Net.Uri> (native_path, JniHandleOwnership.DoNotTransfer);
			IntPtr __ret = JNIEnv.ToLocalJniHandle (__this.OpenConnection (path));
			return __ret;
		}
#pragma warning restore 0169
		...
		protected virtual unsafe global::Java.Net.HttpURLConnection OpenConnection (global::Android.Net.Uri path)
		{
			const string __id = "openConnection.(Landroid/net/Uri;)Ljava/net/HttpURLConnection;";
			try {
				JniArgumentValue* __args = stackalloc JniArgumentValue [1];
